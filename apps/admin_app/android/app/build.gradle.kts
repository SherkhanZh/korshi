...
//   storeFile=/absolute/path/to/korshi-admin-release.jks
//   storePassword=...
//   keyAlias=...
//   keyPassword=...
// Generate the keystore once with:
//   keytool -genkey -v -keystore korshi-admin-release.jks -keyalg RSA -keysize 2048 -validity 10000 -alias korshi-admin
...
android {
    namespace = "com.sherkhanzhantali.korshi_admin"
    ...
    defaultConfig {
        ...
        applicationId = "com.sherkhanzhantali.korshi_admin"
